...
function showMessages() {
    ...
    credentials_buttons.style.display = "none"
    credentials_inputs.style.display = "none;"
...
function showLogin() {
    ...
    credentials_buttons.style.display = "block";
    credentials_inputs.style.display = "block";
    message_section.style.display = "none"
    logout_button.style.display = "none";
